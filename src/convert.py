...
def convert_and_upload_supervisely_project(
    ...
    dataset_path = os.path.join("Blood Cell Segmentation","BCCD Dataset with mask")
    images_folder = "original"
    masks_folder = "mask"
    batch_size = 50
    mask_ext = ".png"
    ...
    def create_ann(image_path):
        ...
        mask_path = os.path.join(masks_path, image_name + mask_ext)
    ...
    obj_class = sly.ObjClass("blood_cell", sly.Bitmap)
